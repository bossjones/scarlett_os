...
project = u"ScarlettOS"
copyright = u"2016, Malcolm Jones"
...
release = scarlett_os.__version__
...
htmlhelp_basename = "scarlett_osdoc"
...
man_pages = [
    ("index", "scarlett_os", u"ScarlettOS Documentation", [u"Malcolm Jones"], 1)
]
