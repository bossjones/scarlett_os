...
if __name__ == "__main__":
    ...
    parser.add_argument("cmd", help="cmd to run. Options [bootstrap, dump_env, compile, render-dry-run, render, pip-install-meson, compile-gtk-doc, clone-all, get-all-tar-files, untar-files, build, compile-all]")
