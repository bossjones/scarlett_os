# coding: utf-8
"""Constants used by ScarlettOS automations."""
...
PROJECT_DESCRIPTION = ('Voice activated Open-source home automation platform '
                       'running on Python 3.')
PROJECT_LONG_DESCRIPTION = ('S.C.A.R.L.E.T.T is Tony Darks artificially programmed'
                            'intelligent computer. She is programmed to speak with a'
                            'female voice in a British accent.')
PROJECT_CLASSIFIERS = [
...
PROJECT_GITHUB_REPOSITORY = 'scarlett_os'
...
# #### EVENTS ####
EVENT_SCARLETT_OS_START = 'scarlett_os_start'
EVENT_SCARLETT_OS_STOP = 'scarlett_os_stop'
EVENT_SCARLETT_OS_CLOSE = 'scarlett_os_close'
...
# #### SERVICES ####
SERVICE_SCARLETT_OS_STOP = 'stop'
SERVICE_SCARLETT_OS_RESTART = 'restart'
...
URL_API_COMPONENTS = '/api/automations'
